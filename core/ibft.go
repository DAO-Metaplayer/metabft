...
// METABFT represents a single instance of the METABFT state machine
type METABFT struct {
	// log is the logger instance
	log Logger

	// state is the current METABFT node state
	state *state
...
// NewMETABFT creates a new instance of the METABFT consensus protocol
func NewMETABFT(
	log Logger,
	backend Backend,
	transport Transport,
...
func SetMeasurementTime(prefix string, startTime time.Time) {
	metrics.SetGauge([]string{"metabft", prefix, "duration"}, float32(time.Since(startTime).Seconds()))
}

// startRoundTimer starts the exponential round timer, based on the
// passed in round number
func (i *METABFT) startRoundTimer(ctx context.Context, round uint64) {
	defer i.wg.Done()
...
func (i *METABFT) signalRoundExpired(ctx context.Context) {
	select {
...
func (i *METABFT) signalRoundDone(ctx context.Context) {
	select {
...
func (i *METABFT) signalNewRCC(ctx context.Context, round uint64) {
	select {
...
func (i *METABFT) signalNewProposal(ctx context.Context, event newProposalEvent) {
	select {
...
func (i *METABFT) watchForFutureProposal(ctx context.Context) {
	var (
...
// trigger a round hop
func (i *METABFT) watchForRoundChangeCertificates(ctx context.Context) {
	defer i.wg.Done()
...
// RunSequence runs the METABFT sequence for the specified height
func (i *METABFT) RunSequence(ctx context.Context, h uint64) {
	startTime := time.Now()
...
func (i *METABFT) startRound(ctx context.Context) {
...
func (i *METABFT) handleRoundChangeMessage(view *proto.View) *proto.RoundChangeCertificate {
	var (
		height              = view.Height
...
// against a proposal
func (i *METABFT) proposalMatchesCertificate(
...
func (i *METABFT) runStates(ctx context.Context) {
	var timeout error
...
// runNewRound runs the New Round METABFT state
func (i *METABFT) runNewRound(ctx context.Context) error {
...
// matter the round
func (i *METABFT) validateProposalCommon(msg *proto.Message, view *proto.View) bool {
	var (
		height = view.Height
		round  = view.Round
...
func (i *METABFT) validateProposal0(msg *proto.Message, view *proto.View) bool {
	var (
		height = view.Height
		round  = view.Round
	)
...
func (i *METABFT) validateProposal(msg *proto.Message, view *proto.View) bool {
	var (
		height = view.Height
		round  = view.Round
...
func (i *METABFT) handlePrePrepare(view *proto.View) *proto.Message {
...
// runPrepare runs the Prepare METABFT state
func (i *METABFT) runPrepare(ctx context.Context) error {
...
func (i *METABFT) handlePrepare(view *proto.View) bool {
...
// runCommit runs the Commit METABFT state
func (i *METABFT) runCommit(ctx context.Context) error {
...
func (i *METABFT) handleCommit(view *proto.View) bool {
...
func (i *METABFT) moveToNewRound(round uint64) {
...
func (i *METABFT) buildProposal(ctx context.Context, view *proto.View) *proto.Message {
	var (
		height = view.Height
		round  = view.Round
	)
...
func (i *METABFT) acceptProposal(proposalMessage *proto.Message) {
	//	accept newly proposed block and move to PREPARE state
	i.state.setProposalMessage(proposalMessage)
	i.state.changeState(prepare)
}

// AddMessage adds a new message to the METABFT message system
func (i *METABFT) AddMessage(message *proto.Message) {
...
func (i *METABFT) isAcceptableMessage(message *proto.Message) bool {
...
func (i *METABFT) sendPreprepareMessage(message *proto.Message) {
	i.transport.Multicast(message)
}

// sendRoundChangeMessage sends out the round change message
func (i *METABFT) sendRoundChangeMessage(height, newRound uint64) {
...
func (i *METABFT) sendPrepareMessage(view *proto.View) {
	i.transport.Multicast(
...
func (i *METABFT) sendCommitMessage(view *proto.View) {
	i.transport.Multicast(
...
func (i *METABFT) hasQuorumByMsgType(msgs []*proto.Message, msgType proto.MessageType) bool {
	switch msgType {
...
func (i *METABFT) subscribe(details messages.SubscriptionDetails) *messages.Subscription {
