...
func TestRunNewRound_Proposer(t *testing.T) {
	...
	t.Run(
		...
		func(t *testing.T) {
			...
			i := NewMETABFT(log, backend, transport)
			i.messages = messages
...
// TestMETABFT_IsAcceptableMessage makes sure invalid messages
// are properly handled
func TestMETABFT_IsAcceptableMessage(t *testing.T) {
	t.Parallel()
...
// TestMETABFT_StartRoundTimer makes sure that the
// round timer behaves correctly
func TestMETABFT_StartRoundTimer(t *testing.T) {
	t.Parallel()
...
// TestMETABFT_MoveToNewRound makes sure the state is modified
// correctly during round moves
func TestMETABFT_MoveToNewRound(t *testing.T) {
	t.Parallel()
...
// TestMETABFT_FutureProposal checks the
// behavior when new proposal messages appear
func TestMETABFT_FutureProposal(t *testing.T) {
	t.Parallel()
...
// TestMETABFT_ValidPC validates that prepared certificates
// are verified correctly
func TestMETABFT_ValidPC(t *testing.T) {
	t.Parallel()
...
func TestMETABFT_ValidateProposal(t *testing.T) {
	t.Parallel()
...
// TestMETABFT_WatchForFutureRCC verifies that future RCC
// are handled properly
func TestMETABFT_WatchForFutureRCC(t *testing.T) {
	t.Parallel()
...
// TestMETABFT_RunSequence_NewProposal verifies that the
// state changes correctly when receiving a higher proposal event
func TestMETABFT_RunSequence_NewProposal(t *testing.T) {
	t.Parallel()
...
// TestMETABFT_RunSequence_FutureRCC verifies that the
// state changes correctly when receiving a higher RCC event
func TestMETABFT_RunSequence_FutureRCC(t *testing.T) {
	t.Parallel()
...
// TestMETABFT_ExtendRoundTimer makes sure the round timeout
// is extended correctly
func TestMETABFT_ExtendRoundTimer(t *testing.T) {
	t.Parallel()
...
func TestMETABFT_AddMessage(t *testing.T) {
	t.Parallel()
